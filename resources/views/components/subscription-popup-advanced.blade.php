                ...
                @if(!empty($warnings))
                    <div class="space-y-3">
                        @foreach($warnings as $warning)
                            ...
                            <div class="flex items-start p-3 border rounded-lg {{ $warningColors['border'] }} {{ $warningColors['bg'] }}">
                                <svg class="w-5 h-5 {{ $warningColors['icon'] }} mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="p-3 border border-blue-200 rounded-lg bg-blue-50">
                    <div class="flex">
                        ...
                        <p class="text-sm text-blue-800">
                            <strong>Dica:</strong> Faça upgrade do seu plano para evitar interrupções no serviço e ter acesso a mais recursos.
                        </p>
                    </div>
                </div>
            </div>
