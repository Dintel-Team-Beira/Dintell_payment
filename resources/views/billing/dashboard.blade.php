        ...
        <div class="p-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <a href="{{ route('quotes.create') }}"
                   class="flex items-center p-4 transition-all duration-200 border border-purple-200 rounded-lg group hover:border-purple-300 hover:shadow-md">
                    <div class="flex-shrink-0">
                ...
                <a href="{{ route('clients.create') }}"
                   class="flex items-center p-4 transition-all duration-200 border border-green-200 rounded-lg group hover:border-green-300 hover:shadow-md">
                    <div class="flex-shrink-0">
                ...
                <a href="/billing/reports"
                   class="flex items-center p-4 transition-all duration-200 border border-gray-200 rounded-lg group hover:border-gray-300 hover:shadow-md">
                    <div class="flex-shrink-0">
