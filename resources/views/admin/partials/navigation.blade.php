        ...
        <ul role="list" class="-mx-2 space-y-1">
            ...
            <li>
                <a href="{{ route('admin.dashboard') }}"
                    ...
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.dashboard') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
            ...
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.companies.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.companies.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ route('admin.users.index') }}"
                    ...
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.users.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ route('admin.invoices.index') }}"
                    ...
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.invoices.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.reports.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.reports.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.plans.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.plans.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ route('admin.subscriptions.index') }}"
                    class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('admin.subscriptions.*') ? 'bg-gray-50 text-blue-600' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}">
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.subscriptions.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.settings.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.settings.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <ul role="list" class="mt-2 -mx-2 space-y-1">
            <li>
                <a href="{{ route('admin.logs.index') }}"
                    ...
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.logs.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m6.75 18H9M1.5 8.25h7.5m-7.5 3.75h7.5m-7.5 3.75h7.5" />
                    </svg>
                    Logs do Sistema
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('admin.monitoring.performance') }}"
                    ...
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.monitoring.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ route('admin.monitoring.health') }}"
                    ...
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.monitoring.health') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span class="ml-auto">
                        <span class="flex w-2 h-2">
                            <span
                                class="absolute inline-flex w-2 h-2 bg-green-400 rounded-full opacity-75 animate-ping"></span>
            ...
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.support.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.support.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        @php
                            $pendingTickets = \App\Models\SupportTicket::whereIn('status', [
                                'open',
                                'pending',
                            ])->count();
                        @endphp
                        @if ($pendingTickets > 0)
                            <span
                                class="inline-flex items-center px-2 py-1 ml-2 text-xs font-medium text-red-700 rounded-full bg-red-50 ring-1 ring-inset ring-red-600/10">
                                {{ $pendingTickets }}
                            </span>
                        @endif
                    ...
                    <ul x-show="open" x-transition class="px-2 mt-1 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('admin.support.tickets') }}"
                                ...
                                @if ($pendingTickets > 0)
                                    <span
                                        class="ml-auto inline-flex items-center rounded-full bg-red-50 px-1.5 py-0.5 text-xs font-medium text-red-700">
                                        {{ $pendingTickets }}
                                    </span>
                                @endif
                            </a>
                ...
                <ul role="list" class="mt-2 -mx-2 space-y-1">
                    <li>
                        <a href="{{ route('admin.help.documentation') }}"
                            ...
                            <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.help.documentation') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.help.api-docs') }}"
                            ...
                            <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.help.api-docs') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.help.changelog') }}"
                            ...
                            <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.help.changelog') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
