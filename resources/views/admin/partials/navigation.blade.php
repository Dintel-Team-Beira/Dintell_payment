        ...
        <ul role="list" class="mt-2 -mx-2 space-y-1">
            <li>
                <a href="{{ route('admin.support.tickets') }}"
                   class="flex p-2 text-sm font-semibold leading-6 text-gray-700 rounded-md group gap-x-3 hover:text-blue-600 hover:bg-gray-50">
                    <svg class="w-6 h-6 text-gray-400 shrink-0 group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
