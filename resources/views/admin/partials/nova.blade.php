...
<ul role="list" class="flex flex-col flex-1 gap-y-7">
        ...
        <ul role="list" class="-mx-2 space-y-1">
            ...
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.users.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                            class="group flex w-full items-center gap-x-3 rounded-md p-2 text-left text-sm leading-6 font-semibold {{ request()->routeIs('admin.users.*') ? 'bg-gray-50 text-blue-600' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}">
                        ...
                        Usuários
                        <svg class="ml-auto h-5 w-5 shrink-0 {{ request()->routeIs('admin.users.*') ? 'text-blue-600 rotate-90' : 'text-gray-400 group-hover:text-blue-600' }}"
                             :class="{ 'rotate-90': open }"
                             viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <ul x-show="open" x-transition class="px-2 mt-1 space-y-1">
                        <li>
                            <a href="{{ route('admin.users.index') }}"
                               class="group flex gap-x-3 rounded-md py-2 pl-9 pr-2 text-sm leading-6 {{ request()->routeIs('admin.users.index') ? 'text-blue-600 font-semibold' : 'text-gray-700 hover:text-blue-600' }}">
                                Listar Usuários
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.users.create') }}"
                               class="group flex gap-x-3 rounded-md py-2 pl-9 pr-2 text-sm leading-6 {{ request()->routeIs('admin.users.create') ? 'text-blue-600 font-semibold' : 'text-gray-700 hover:text-blue-600' }}">
                                Novo Usuário
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul x-show="open" x-transition class="px-2 mt-1 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('admin.reports.companies') }}"
                               class="group flex gap-x-3 rounded-md py-2 pl-9 pr-2 text-sm leading-6 {{ request()->routeIs('admin.reports.companies') ? 'text-blue-600 font-semibold' : 'text-gray-700 hover:text-blue-600' }}">
                                Empresas
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.reports.users') }}"
                               class="group flex gap-x-3 rounded-md py-2 pl-9 pr-2 text-sm leading-6 {{ request()->routeIs('admin.reports.users') ? 'text-blue-600 font-semibold' : 'text-gray-700 hover:text-blue-600' }}">
                                Usuários
                            </a>
                        </li>
                        <li>
        ...
        <ul role="list" class="mt-2 -mx-2 space-y-1">
            ...
            <li>
                <a href="{{ route('admin.activities.index') }}"
                   class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('admin.activities.*') ? 'bg-gray-50 text-blue-600' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}">
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.activities.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <li>
                <a href="{{ route('admin.health.index') }}"
                   class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('admin.health.*') ? 'bg-gray-50 text-blue-600' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}">
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.health.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <ul role="list" class="mt-2 -mx-2 space-y-1">
            <li>
                <a href="{{ route('admin.documentation') }}"
                   class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('admin.documentation') ? 'bg-gray-50 text-blue-600' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}">
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.documentation') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <li>
                <a href="{{ route('admin.support') }}"
                   class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('admin.support') ? 'bg-gray-50 text-blue-600' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}">
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.support') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.712 4.33a9.027 9.027 0 011.652 1.306c.51.51.944 1.064 1.306 1.652M16.712 4.33l-3.448 4.138m3.448-4.138a9.014 9.014 0 00-9.424 0M19.67 7.288l-4.138 3.448m4.138-3.448a9.014 9.014 0 010 9.424m-4.138-5.976a3.736 3.736 0 00-.88-1.388 3.737 3.737 0 00-1.388-.88m2.268 2.268a3.765 3.765 0 010 2.528m-2.268-4.796a3.765 3.765 0 00-4.796 4.796m4.796-4.796L7.288 4.33m5.976 0A9.027 9.027 0 004.33 7.288l1.652 1.306a9.014 9.014 0 000 9.424l-1.652 1.306A9.027 9.027 0 0013.264 19.67l-1.306-1.652a9.014 9.014 0 00-9.424 0l-1.306 1.652A9.027 9.027 0 004.33 16.712a3.765 3.765 0 012.528 0"/>
                    </svg>
                    Suporte Técnico
                </a>
            </li>
    ...
    <li class="mt-auto">
        <div class="mt-auto -mx-6">
            <div class="flex items-center px-6 py-3 text-sm font-semibold leading-6 text-gray-900 gap-x-4 hover:bg-gray-50">
                <img class="w-8 h-8 rounded-full bg-gray-50" src="{{ Auth::user()->avatar_url ?? 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&color=7F9CF5&background=EBF4FF' }}" alt="{{ Auth::user()->name }}">
                <span class="sr-only">Seu perfil</span>
                <div class="flex flex-col">
                    <span aria-hidden="true" class="truncate">{{ Auth::user()->name }}</span>
                    <span aria-hidden="true" class="text-xs text-gray-500 truncate">{{ Auth::user()->email }}</span>
                </div>
            </div>

            <!-- Menu de perfil com dropdown -->
            <div class="px-6 py-2 space-y-1">
                <a href="{{ route('admin.profile.edit') }}" class="flex py-2 pl-2 pr-2 text-sm leading-6 text-gray-700 rounded-md group gap-x-3 hover:text-blue-600 hover:bg-gray-50">
                    <svg class="w-4 h-4 text-gray-400 shrink-0 group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="flex w-full py-2 pl-2 pr-2 text-sm leading-6 text-gray-700 rounded-md group gap-x-3 hover:text-red-600 hover:bg-gray-50">
                        <svg class="w-4 h-4 text-gray-400 shrink-0 group-hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
