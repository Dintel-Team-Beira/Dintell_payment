                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>Esta cotação expirou em {{ $quote->valid_until->format('d/m/Y') }}. Entre em contato com o
                                cliente para renovar.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-green-700">
                            <p>Esta cotação foi convertida em fatura em
                                {{ $quote->converted_to_invoice_at->format('d/m/Y H:i') }}.</p>
                            <p class="mt-1">
        ...
        <div class="bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    @endphp
                    <span
                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $statusClasses[$quote->status] }}">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <p
                            class="text-lg font-semibold {{ $quote->isExpired() && $quote->status !== 'accepted' ? 'text-red-600' : 'text-gray-900' }}">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($quote->items as $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="text-sm font-medium text-gray-900">{{ number_format($item->total, 2) }} MT
                                    </div>
                                </td>
                            </tr>
                        @endforeach
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="pt-2 border-t border-gray-200">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-xl font-bold text-green-600">{{ number_format($quote->total, 2) }}
                                        MT</span>
                                </div>
                            </div>
                        </div>
    ...
    <div id="emailModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <form id="emailForm" action="{{ route('quotes.send-email', $quote) }}" method="POST">
                    @csrf
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Envie a cotação para o cliente por email.
                                    </p>
                                </div>
                                <div class="mt-4 space-y-4">
                                    <div>
                                        ...
                                        <input type="email" name="email" id="email_address"
                                            ...
                                            value="{{ $quote->client->email }}" required>
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" name="subject" id="email_subject"
                                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm"
                                            value="Cotação {{ $quote->quote_number }}" required>
                                    </div>
                                    <div>
                                        ...
                                        <textarea name="message" id="email_message" rows="3"
                                            class="block w-full mt-1 p-2 border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm"
