...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <!-- Revenue Chart -->
        <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-xl">
            <h3 class="mb-4 text-lg font-semibold text-gray-900">Receita dos Últimos {{ $period }} Dias</h3>
            <div class="h-64">
        ...
        <!-- Subscriptions Chart -->
        <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-xl">
            <h3 class="mb-4 text-lg font-semibold text-gray-900">Novas Subscrições</h3>
            <div class="h-64">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-xl">
            ...
            <div class="space-y-3">
                <a href="{{ route('subscriptions.create') }}"
                   class="flex items-center p-3 text-sm font-medium text-blue-600 transition-colors rounded-lg bg-blue-50 hover:bg-blue-100">
                ...
                <a href="{{ route('clients.create') }}"
                   class="flex items-center p-3 text-sm font-medium text-green-600 transition-colors rounded-lg bg-green-50 hover:bg-green-100">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"/>
                    </svg>
                    Novo Cliente
                ...
                <a href="{{ route('plans.create') }}"
                   class="flex items-center p-3 text-sm font-medium text-indigo-600 transition-colors rounded-lg bg-indigo-50 hover:bg-indigo-100">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('api-logs.index') }}"
                   class="flex items-center p-3 text-sm font-medium text-purple-600 transition-colors rounded-lg bg-purple-50 hover:bg-purple-100">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-xl">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex items-center justify-center w-10 h-10 text-sm font-medium text-white rounded-full bg-gradient-to-r from-blue-500 to-purple-600">
                ...
                @empty
                <p class="py-4 text-center text-gray-500">Nenhum cliente encontrado</p>
                @endforelse
            </div>
        </div>
        ...
        <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-xl">
            ...
            <div class="space-y-4">
                ...
                @empty
                <p class="py-4 text-center text-gray-500">Nenhuma subscrição expirando</p>
                @endforelse
            </div>
        </div>
    </div>
    ...
    <!-- Recent Activity -->
    <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-xl">
        <h3 class="mb-4 text-lg font-semibold text-gray-900">Atividade Recente</h3>
        ...
        <div class="space-y-4">
            ...
            @empty
            <p class="py-4 text-center text-gray-500">Nenhuma atividade recente</p>
            @endforelse
        </div>
    </div>
    ...
    <!-- API Usage -->
    <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-xl">
        <h3 class="mb-4 text-lg font-semibold text-gray-900">Uso da API (Últimos {{ $period }} dias)</h3>
        <div class="h-32">
